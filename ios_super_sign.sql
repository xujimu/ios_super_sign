...
-- ----------------------------
DROP TABLE IF EXISTS `mdm_distribute`;
CREATE TABLE `mdm_distribute` (
...
-- ----------------------------
DROP TABLE IF EXISTS `mdm_down_code`;
CREATE TABLE `mdm_down_code` (
  `id` varchar(64) NOT NULL,
  `account` varchar(255) NOT NULL,
  `down_code` varchar(255) NOT NULL,
  `create_time` datetime NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `mdm_pack_status`;
CREATE TABLE `mdm_pack_status` (
  `id` varchar(64) NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `mdm_software_distribute`;
CREATE TABLE `mdm_software_distribute` (
...
-- ----------------------------
DROP TABLE IF EXISTS `mdm_software_distribute_down_record`;
CREATE TABLE `mdm_software_distribute_down_record` (
...
-- ----------------------------
DROP TABLE IF EXISTS `mdm_software_distribute_down_record_info`;
CREATE TABLE `mdm_software_distribute_down_record_info` (
...
-- ----------------------------
DROP TABLE IF EXISTS `mdm_super_update_ipa_task`;
CREATE TABLE `mdm_super_update_ipa_task` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='设置';
...
-- ----------------------------
DROP TABLE IF EXISTS `software_distribute_down_record`;
CREATE TABLE `software_distribute_down_record` (
  `record_id` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `systemctl_settings`;
